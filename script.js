...
// Exercice 4
// Insérez votre code ici
const user = ["firstname", "lastname", age, year]
// Ne touchez pas à ceci
...
const car = {
  ...
  yearConstruct : 2020,
  color : "Dark Grey",
  image : "https://www.mercedes-benz.be/fr/passengercars/mercedes-benz-cars/models/amg-gt/coupe-c190/design/model-comparison/_jcr_content/comparisonslider/par/comparisonslide_379682962/exteriorImage.MQ6.12.20200907115807.jpeg",
};
// Ne touchez pas à ceci
document.getElementById(
  "firstItem"
...
// Exercice 9
// Insérez votre code ici
const myArray = ["Java Script", "Figma","HTML CSS", "Illustrator"];
let myListOuput = document.getElementById("listOutput");
myArray.forEach(element => {
 myListOuput.innerHTML += `<li>${element}</li>`;
});
...
const arrayLenght = icons.length-1;
const randomIndex = Math.round(Math.random() *arrayLenght);
const iconURL = `./images/${icons[randomIndex]}.svg`;
...
function changeIcon() {
    ...
    const iconURL = `./images/${selectedIcon}.svg`; 
    
    iconImage.src = iconURL;

        console.log(`Icon changed to: ${selectedIcon}`);
}
